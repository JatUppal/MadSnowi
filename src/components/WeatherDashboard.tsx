...
const WeatherDashboard: React.FC<WeatherDashboardProps> = ({ city = 'Madison' }) => {
  ...
  if (loading) {
    return (
      <Card className="bg-gradient-ice shadow-snow animate-pulse">
  ...
  if (!weatherData) {
    return (
      <Card className="bg-gradient-ice shadow-snow">
  ...
  return (
    <Card className="bg-gradient-ice shadow-snow border-accent/30">
      <div className="p-4 space-y-4">
        ...
        {/* Winter travel alert */}
        {weatherData.snow_depth > 3 && (
          <div className="mt-3 p-2 bg-winter-caution/10 border border-winter-caution/30 rounded-md">
